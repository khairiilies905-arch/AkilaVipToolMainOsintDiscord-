...
def main():
    clear.clear()
    COLs = Colorate.Diagonal(Colors.red_to_green, ascii_)
    print(COLs)
...
├─ [05] Discord Webhook Info            ├─ [10] Discord Bot ID to Invite        ├─ [15] EXIT Discord Menu
  ...
  '''
  coilorat = Colorate.Diagonal(Colors.red_to_green, ascii_discord)
  print(coilorat)
...
"""
  COLorss = Colorate.Diagonal(Colors.red_to_green, ascii_osint)
  print(COLorss)
